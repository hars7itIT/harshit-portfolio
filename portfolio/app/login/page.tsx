...
import { Cpu, ShieldCheck, Mail, Lock, LogIn, ArrowRight } from "lucide-react";
      ...
      <div className="w-full max-w-sm z-10 space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-[10px] text-slate-500 font-mono uppercase tracking-widest">
            Verification required for administrative sync
          </p>
        </div>
        ...
        <div className="glass-card p-6 relative">
          ...
          <form onSubmit={handleLogin} className="space-y-4 font-mono text-xs">
            ...
            <div className="space-y-1.5">
              <label className="block text-[9px] uppercase tracking-wider text-slate-400 flex items-center gap-1">
                <Lock size={10} className="text-purple-400" /> Key Code
              </label>
              <input
                type="password"
                value={password}
        ...
        <div className="text-center">
          ...
          >
            Request New Node Access <ArrowRight size={10} />
          </Link>
        </div>
      </div>
    </div>
