...
export default function Hero() {
  ...
  return (
    <div className="space-y-12">
      {/* 2-Column top section: Intro + circular avatar */}
      <div className="grid gap-8 lg:grid-cols-12 items-center">
        ...
        <div className="lg:col-span-5 flex flex-col items-center justify-center relative select-none p-4">
          ...
          <div className="text-center mt-5 space-y-1">
            <h4 className="font-mono text-xs font-bold text-text uppercase tracking-widest flex items-center gap-1.5 justify-center">
              <span>JARVIS</span>
            </h4>
            <p className="font-mono text-[9px] text-muted uppercase tracking-wider flex items-center gap-1 justify-center">
              <span className="h-1.5 w-1.5 rounded-full bg-emerald-400 animate-pulse" />
      ...
      {/* Stats Grid */}
      <div className="grid gap-4 grid-cols-2 sm:grid-cols-6 w-full">
        {/* What I Do Card */}
        <div className="col-span-2 rounded-2xl border border-line bg-surface/20 p-5 backdrop-blur-sm relative overflow-hidden group hover:border-cyan-500/25 transition-all">
          <div className="absolute top-0 right-0 p-3 opacity-10 group-hover:opacity-20 transition-opacity">
            <Cpu size={30} className="text-cyan-400" />
          </div>
          <h3 className="font-mono text-[10px] font-bold text-cyan-400 uppercase tracking-widest flex items-center gap-2">
            <span className="h-1.5 w-1.5 rounded-full bg-cyan-400 animate-pulse" />
            What I Do
          </h3>
          <p className="mt-3 text-xs text-muted leading-relaxed font-mono">
            I build full stack web apps and AI powered solutions that solve user world problems.
          </p>
          <button
            onClick={() => handleScrollTo("about")}
            className="mt-4 font-mono text-[9px] text-cyan-400 hover:text-cyan-300 font-bold uppercase tracking-wider flex items-center gap-1 group/btn cursor-pointer"
          >
        ...
        <div className="rounded-2xl border border-line bg-surface/20 p-5 backdrop-blur-sm relative overflow-hidden group hover:border-cyan-500/25 transition-all text-center sm:text-left flex flex-col justify-center">
          <div className="text-2xl font-black text-text font-mono tracking-tight group-hover:text-cyan-400 transition-colors">10+</div>
          <div className="font-mono text-[8px] font-bold text-muted uppercase tracking-wider mt-1">Projects Completed</div>
        </div>

        {/* Stats card: 2+ Years */}
        <div className="rounded-2xl border border-line bg-surface/20 p-5 backdrop-blur-sm relative overflow-hidden group hover:border-cyan-500/25 transition-all text-center sm:text-left flex flex-col justify-center">
          <div className="text-2xl font-black text-text font-mono tracking-tight group-hover:text-cyan-400 transition-colors">2+</div>
          <div className="font-mono text-[8px] font-bold text-muted uppercase tracking-wider mt-1">Years of Learning</div>
        </div>

        {/* Stats card: 15+ Tech */}
        <div className="rounded-2xl border border-line bg-surface/20 p-5 backdrop-blur-sm relative overflow-hidden group hover:border-cyan-500/25 transition-all text-center sm:text-left flex flex-col justify-center">
          <div className="text-2xl font-black text-text font-mono tracking-tight group-hover:text-cyan-400 transition-colors">15+</div>
          <div className="font-mono text-[8px] font-bold text-muted uppercase tracking-wider mt-1">Technologies Mastered</div>
        </div>

        {/* Stats card: Passion */}
        <div className="rounded-2xl border border-line bg-surface/20 p-5 backdrop-blur-sm relative overflow-hidden group hover:border-cyan-500/25 transition-all text-center sm:text-left flex flex-col justify-center">
          <div className="text-2xl font-black text-text font-mono tracking-tight group-hover:text-cyan-400 transition-colors">100%</div>
          <div className="font-mono text-[8px] font-bold text-muted uppercase tracking-wider mt-1">Passion & Dedication</div>
        </div>
      </div>
    </div>
  );
